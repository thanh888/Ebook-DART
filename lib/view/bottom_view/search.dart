...
import 'package:ebook_app/controller/con_search.dart';
...
class _SearchState extends State<Search> {
  late Future<List<ModelEbook>> getSearch;
  List<ModelEbook> listSearch = [];

  @override
  void initState() {
    super.initState();
    getSearch = fetchSeach(listSearch,widget.search);
  }
